...
class State:
    ...
    """
    This Class sets the move by validating the move considering
    the empty cells remaining at each point in the game,
    it also renders the board and prints it out to the terminal
    """
    # initialising all the variables
    def __init__(self, c_choice,
                 h_choice, state=[[0, 0, 0], [0, 0, 0], [0, 0, 0]]):
    ...
    def __str__(self):
        return ("The human choice for this game is "
                + self.h_choice.upper() + " and the computer choice is "
                + self.c_choice.upper()
                )
...
class Play:
    """
    This class sets the human turn and ai turn by
    setting moves, validating moves and rendering the board.
    """
